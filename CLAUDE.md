...
## Editing the Full Scripture

Edits to `CHURCH-OF-CODE.md` follow the editorial rules documented in [README.md](README.md#editorial-rules): Sacred Scrolls ordering, prophet citation density, metaphor density, serpent voice, and preamble register. Consult those before proposing changes to the canonical scripture.
